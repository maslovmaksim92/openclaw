...
## Что это
Принудительно переоткрытый кейс `1028-msk-sanas-geo-expand-v2` из backlog resurrect/rerun для новой аналитики по полному пайплайну.

## Почему кейс создан
- Файл `2026-04-19-resurrect-1028-msk-sanas-geo-expand.md` подпадает под обязательное правило Force Full Pipeline.
